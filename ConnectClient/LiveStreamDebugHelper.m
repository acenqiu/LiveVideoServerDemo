...
@implementation LiveStreamDebugHelper

+ (void)translateNALUType:(int)type
{
    NSLog(@"[Live Stream] ~~~~~~~~~>>>> NALU type %@", naluTypesStrings[type]);
}

+ (void)translateNALUType:(int)type size:(int)size
{
    NSLog(@"[Live Stream] ~~~~~~~~~>>>> NALU type %@, size=%d", naluTypesStrings[type], size);
}
